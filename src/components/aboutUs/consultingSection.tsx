      ...
      <Flex direction="column" gap="3rem">
        ...
        <Flex direction={'column'} gap={'1rem'}>
          <Text fontWeight={500} fontSize="1em" fontFamily="'Lexend', sans-serif" color="#202122">
            Here at FAULMATA Energy Group we aspire to be your long-term strategic partner, to help you sustainably and equitably contribute to Latin America role in the global energy transition. Whatever your idea, goal or project, FAULMATA will help you make it happen.        </Text>
